      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6 text-center">
        <div className="mb-8 flex flex-col items-center">
          <div className="relative mb-6">
            <div className="w-24 h-24 md:w-32 md:h-32 rounded-full border-4 border-cyan-400 bg-gradient-to-br from-cyan-950 to-emerald-950 flex items-center justify-center shadow-2xl overflow-hidden p-3 transform transition-transform hover:rotate-6">
               <img 
            ...
            <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 flex flex-col items-center">
               <div className="bg-red-500 text-white px-6 md:px-10 py-1.5 rounded-md shadow-lg text-sm font-bold flex flex-col leading-tight whitespace-nowrap">
                  <span>ورشة سلام</span>
                  <span className="text-[9px] font-normal opacity-90 text-center">by Ahmed Abdo</span>
               </div>
            </div>
          </div>
